...
//Question 4
				...
				var operator = "";
				while (operator === null || operator === "" || operator != Number(operator) || (operator == 1 && num2 == 0) || (operator == 2 && num2 == 0)) {
...
//Question 6
  ...
  var number = "";
  while (number === "" || number === null || number != Number(number) || number.indexOf(".") != -1) {
...
//Question 8
  ...
  function calculateHypotenuse(base, perpendicular) {
  	  if (base <= 0 || perpendicular <= 0 || base != Number(base) || perpendicular != Number(perpendicular)) {
  	  				return null;
  	  }
  	  ...
  	  return Math.sqrt(sqrBase + sqrPerpendicular).toFixed(2);
...
//Question 9
  ...
  function calcTriangleArea(width, height) {
  				if (width <= 0 || height <= 0 || width != Number(width) || height != Number(height)) {
  								return null;
  				}
...
//Question 13
				...
				function countOccurrence(str, chr) {
								if (typeof str === "number" || typeof chr === "number" || string.indexOf(" ") !== -1 || chr.length !== 1) {
												return null;
								}
								var chrCount = 0;
				...
				if (occurrence !== null) {
				  document.write("The character " + "'" + character + "'" + " appears in the word " + string + " " + occurrence + " time(s).")
				}
				else {
